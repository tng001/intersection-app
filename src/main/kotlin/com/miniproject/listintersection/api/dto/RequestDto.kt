...
class RequestDto(
    ...
    @field:NotEmpty(message = "{request.toputinhashset.notempty.message}")
    var toPutInHashset: String,

    @field:NotEmpty(message = "{request.toiterateover.notempty.message}")
    var toIterateOver: String
)